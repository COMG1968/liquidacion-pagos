...
export default function Page(){
 ...
 async function save(){
  ...
  let payload={trabajador_id:Number(worker),fecha_desde:from,fecha_hasta:to,valor_hora:Number(rate),total_horas:totalHours,total_pago:total,observaciones:obs||null,estado:status,metodo_pago_id:status==='pagado'?Number(method):null,gran_total:grandTotal}
  let id=editId
